    ...
    <div className="min-h-screen bg-slate-900 bg-gradient-to-br from-[#0A192F] to-[#122c54] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white/95 backdrop-blur-md p-8 rounded-2xl max-w-sm w-full shadow-2xl border border-slate-100/50 z-10 flex flex-col text-center">
        ...
        <button 
          onClick={onLogin} 
          disabled={loading}
          className="w-full bg-[#0A192F] hover:bg-slate-800 disabled:opacity-50 text-white font-extrabold text-xs py-3 px-4 rounded-xl shadow-md transition-all flex items-center justify-center gap-2.5 active:scale-[0.98]"
        >
          {loading ? (
          ...
          {loading ? 'Autenticando...' : 'Autenticar com Google'}
        </button>
